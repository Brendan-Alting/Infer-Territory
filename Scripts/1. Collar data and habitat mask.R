...
RedDogCleandates <- RedDogCleandates[-which(is.na(RedDogCleandates$Latitude)),]
...
#Take random sample of 1000 points for each 
...
mask1sf$distancetocore23 <- ifelse(mask1sf$distancetocore23 == Inf, 1000, mask1sf$distancetocore23)

mask1sf$distancetocore22 <- ifelse(mask1sf$distancetocore22 == Inf, 1000, mask1sf$distancetocore22)
