...
plot22cam <- ggplot(valuescentres2022, aes(x = x, y = y, color = D.sum.category)) +
  scale_color_manual("Predicted Activity\nCentre Density-\nPossible Cores",values = c("Grey","lightyellow","Yellow","#FFB84D","Orange","DarkOrange", "Red","DarkRed","Black"))+
  geom_point(size = 2) +
  geom_point(data = trapsallPS2022, aes(x = x, y = y), shape = 17, size = 3, color = "black") +
  labs(x = "x",
       y = "y",
...
png("Figures Reanalysis/2022a.png", width = 10, height = 15, res= 300, units = "in")
twentytwoa
dev.off()

png("Figures Reanalysis/2022b.png", width = 10, height = 15, res= 300, units = "in")
twentytwob
dev.off()

png("Figures Reanalysis/2023a.png", width = 10, height = 15, res= 300, units = "in")
twentythreea
dev.off()
